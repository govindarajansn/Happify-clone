            ...
            return(
                <>
                    ...
                    <tbody>
                    {
                        ...
                        <td>
                            {
                               items.track.artists.map((item) =>
                               <a className="active" href={"/artist/"+item.id}>{item.name}</a>
                               ) 
                            }
                        </td>
                        <td>{items.track.duration_ms}</td>
                        <td>{items.track.popularity}</td>
                        <td>
                        <audio controls>
                            <source src={items.track.preview_url} type="audio/ogg"></source>
                            <source src={items.track.preview_url} type="audio/mpeg"></source>
                            Your browser does not support the audio element.
                        </audio>
                        </td>
                        <td>
                            <a href={"/audio_analysis/"+items.track.id}>
